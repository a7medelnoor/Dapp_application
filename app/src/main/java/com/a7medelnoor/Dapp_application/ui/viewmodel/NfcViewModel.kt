...
import com.a7medelnoor.Dapp_application.app.Coroutines
import com.a7medelnoor.Dapp_application.app.NFCStatus
import com.a7medelnoor.Dapp_application.app.NfcManager
...
class NfcViewModel : AndroidViewModel {
    ...
    fun readTag(tag: Tag?) {
        Coroutines.default(this@NfcViewModel, {
            ...
            Timber.tag(ContentValues.TAG).d("dumpTagData Return " + "\n" + " " + stringBuilder)
